...
minetest.register_lamp_post("lighting:lamp_post_black_iron", {
	...
	inventory_image = "lamp_post_black_iron_inv.png",
	wield_image = "lamp_post_black_iron_inv.png",
...
minetest.register_lamp_post("lighting:lamp_post_iron", {
	...
	inventory_image = "lamp_post_iron_inv.png",
	wield_image = "lamp_post_iron_inv.png",
	material = "metal:iron",
	groups = {cracky = 3},
	sounds = default.node_sound_metal_defaults(),
})
...
minetest.register_lamp_post("lighting:lamp_post_rusted", {
	...
	inventory_image = "lamp_post_rusted_inv.png",
	wield_image = "lamp_post_rusted_inv.png",
