...
minetest.register_node("wood:maple_bookshelf", {
	...
	tiles = {"wood_maple_planks.png", "wood_maple_planks.png",
			...
			"wood_maple_planks.png", "wood_maple_planks.png^wood_bookshelf.png"},
	paramtype = "light",
	paramtype2 = "facedir",
...
local function book_on_use(itemstack, user)
	...
	minetest.show_formspec(player_name, "wood:book", formspec)
	return itemstack
end
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname ~= "wood:book" then return end
	...
	if fields.save and fields.title and fields.text
		...
		if stack:get_name() ~= "wood:book_written" then
			local count = stack:get_count()
			if count == 1 then
				stack:set_name("wood:book_written")
			else
				stack:set_count(count - 1)
				new_stack = ItemStack("wood:book_written")
			end
		else
...
minetest.register_craftitem("wood:book", {
	description = "Book",
	inventory_image = "wood_book.png",
	groups = {book = 1, flammable = 3},
	on_use = book_on_use,
})

minetest.register_craftitem("wood:book_written", {
	description = "Book With Text",
	inventory_image = "wood_book_written.png",
...
minetest.register_craft({
	type = "shapeless",
	output = "wood:book_written",
	recipe = {"wood:book", "wood:book_written"}
})

minetest.register_on_craft(function(itemstack, player, old_craft_grid, craft_inv)
	if itemstack:get_name() ~= "wood:book_written" then
		return
	end
	...
	for i = 1, player:get_inventory():get_size("craft") do
		if old_craft_grid[i]:get_name() == "wood:book_written" then
