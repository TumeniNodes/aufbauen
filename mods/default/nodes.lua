...
default:meselamp (possibly keep mese but in a diff form)
...
minetest.register_node("default:granite_block_half", {
	description = "Granite Block Half",
	tiles = {"default_granite_block_half.png"},
	is_ground_content = false,
	paramtype2 = "facedir",
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node("default:limestone_brick", {
...
minetest.register_node("default:limestone_block", {
	description = "Limestone Block",
	tiles = {"default_limestone_block.png"},
	is_ground_content = false,
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("default:limestone_block_half", {
	description = "Limestone Block Half",
	tiles = {"default_limestone_block_half.png"},
	is_ground_content = false,
	paramtype2 = "facedir",
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node("default:limestone_cinderblock", {
	description = "Limestone Cinderblock",
	tiles = {"default_limestone_cinderblock.png"},
	is_ground_content = false,
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("default:limestone_smooth", {
	description = "Smooth Limestone",
	tiles = {"default_limestone_smooth.png"},
	is_ground_content = false,
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:sandstone_block_half", {
	description = "Sandstone Block Half",
	tiles = {"default_sandstone_block_half.png"},
	is_ground_content = false,
	paramtype2 = "facedir",
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node("default:sandstone_cinderblock", {
	description = "Sandstone Cinderblock",
	tiles = {"default_sandstone_cinderblock.png"},
	is_ground_content = false,
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:sandstone_smooth", {
	...
	tiles = {"default_sandstone_smooth.png"},
	is_ground_content = false,
	groups = {cracky = 2},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:stone_block_mossy", {
...
minetest.register_node("default:stone_block_half", {
	description = "Stone Block Half",
	tiles = {"default_stone_block_half.png"},
	is_ground_content = false,
	paramtype2 = "facedir",
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node("default:stone_block_half_mossy", {
	description = "Mossy Stone Block Half",
	tiles = {"default_stone_block_half_mossy.png"},
	is_ground_content = false,
	paramtype2 = "facedir",
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node("default:stone_cinderblock", {
	description = "Stone Cinder Block",
	tiles = {"default_stone_cinderblock.png"},
	is_ground_content = false,
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("default:stone_cinderblock_mossy", {
	description = "Mossy Stone Cinder Block",
	tiles = {"default_stone_cinderblock_mossy.png"},
	is_ground_content = false,
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:stone_smooth_mossy", {
	description = "Mossy Smooth Stone",
	tiles = {"default_stone_smooth_mossy.png"},
	is_ground_content = false,
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:willow_leaves", {
	...
	drop = {
		max_items = 1,
		items = {
			{items = {'default:willow_sapling'}, rarity = 20},
			{items = {'default:willow_leaves'}}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
...
default.register_fence("default:fence_birch_wood", {
	...
	inventory_image = "default_fence_overlay.png^default_birch_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
	wield_image = "default_fence_overlay.png^default_birch_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
...
default.register_fence_rail("default:fence_rail_wood", {
	...
	inventory_image = "default_fence_rail_overlay.png^default_wood.png^default_fence_rail_overlay.png^[makealpha:255,126,126",
	wield_image = "default_fence_rail_overlay.png^default_wood.png^default_fence_rail_overlay.png^[makealpha:255,126,126",
	material = "default:wood",
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
	sounds = default.node_sound_wood_defaults()
})
...
default.register_fence_rail("default:fence_rail_acacia_wood", {
	...
	inventory_image = "default_fence_rail_overlay.png^default_acacia_wood.png^default_fence_rail_overlay.png^[makealpha:255,126,126",
	wield_image = "default_fence_rail_overlay.png^default_acacia_wood.png^default_fence_rail_overlay.png^[makealpha:255,126,126",
	material = "default:acacia_wood",
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
	sounds = default.node_sound_wood_defaults()
})
...
default.register_fence_rail("default:fence_rail_pine_wood", {
	...
	inventory_image = "default_fence_rail_overlay.png^default_pine_wood.png^default_fence_rail_overlay.png^[makealpha:255,126,126",
	wield_image = "default_fence_rail_overlay.png^default_pine_wood.png^default_fence_rail_overlay.png^[makealpha:255,126,126",
	material = "default:pine_wood",
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults()
})
...
default.register_fence_rail("default:fence_rail_birch_wood", {
	description = "Birch Wood Fence Rail",
