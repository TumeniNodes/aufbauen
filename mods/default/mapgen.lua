...
minetest.register_alias("mapgen_stone", "default:rock")
...
function default.register_biomes(upper_limit)
	...
	-- Plains - dry grass, dead shrubs mixed with live nature

	-- Meadows - large oaks large willows large ponds
...
--[[
	...
	if chunksize >= 1 then
		minetest.register_decoration({
			...
			deco_type = "schematic",
			place_on = {"default:dirt_with_rainforest_litter", "default_dirt"},
			sidelen = 80,
			noise_params = {
				offset = 0.0,
				scale = 0.0025,
			...
			biomes = {"rainforest", "rainforest_swamp", "savanna_shore"},
			y_max = 32,
			y_min = 1,
	...
	minetest.register_decoration({
		name = "default:willow_tree",
		deco_type = "schematic",
		place_on = {"default:dirt_with_grass", "default:dirt"},
		sidelen = 80,
		fill_ratio = 0.0080,
		biomes = {"deciduous_forest_shore", "coniferous_forest_shore"},
		y_max = 31000,
		y_min = -1,
		schematic = minetest.get_modpath("default") .. "/schematics/willow_tree.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = minetest.get_modpath("default") .. "/schematics/willow_tree_log.mts",
		flags = "place_center_x",
		rotation = "random",
		spawn_by = "default:dirt_with_grass",
		num_spawn_by = 8,
	...
	minetest.register_decoration({
		...
		biomes = {"coniferous_forest", "deciduous_forest", "grassland"},
		y_max = 31000,
		y_min = 1,
...
for length = 1, 3 do
	minetest.register_decoration({
		...
		y_max = 6,
		y_min = 4,
		decoration = "default:marram_grass_"..length,
		param2 = 8,
    })
end
